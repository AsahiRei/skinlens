...
export default function Profile() {
  ...
  return (
    <View className="flex-1">
      ...
      <View className="flex-1 bg-gray-50 px-6 py-4">
        <View className="w-full rounded-2xl border border-gray-200 bg-white p-5 gap-2">
        ...
        <View className="w-full rounded-2xl border border-gray-200 bg-white p-5 mt-4">
